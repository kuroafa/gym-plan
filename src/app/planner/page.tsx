...
const page = async (props: Props) => {
  ...
  return (
    <div className="">
      <h1 className=" mx-8 md:text-3xl text-xl font-semibold ">Welcome {session.user.name}</h1>
       <h1 className="my-10 mx-8 md:text-3xl text-xl font-semibold ">Fill out information about yourself to get your free customized workout!</h1>
