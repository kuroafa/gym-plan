...
const HerotabOne = ({ trainerData, userData, planData, goalData}: Props) => {
    ...
    <div className="grid xl:grid-cols-4 gap-5 -ml-6">
                          ...
                          return (
                            <div key={train.date}>
                              <h1 className="md:text-md font-semibold">
                                ...
                                {train.client.toUpperCase()} @{train.time}{" "}
                                today.
                              </h1>
                            </div>
                          );
            ...
            <div className="grid xl:grid-cols-2 sm:grid-cols-2 col-span-2 gap-5">
              <div className="rounded-[40px] bg-indigo-500 pb-5">
                ...
                />
                <div className="grid grid-cols-1 px-6 pt-[100px] gap-2">
                  <button className="bg-white text-lg font-semibold rounded-[20px] px-4 py-2 flex justify-between items-center ">
                    Start workouts{" "}
                    <Image
                      alt="workout"
                      className=" "
                  ...
                  <button className="bg-black hover:bg-slate-600 text-white text-lg font-semibold rounded-[20px] px-4 py-2 flex justify-between items-center ">
                    Create new plan <ArrowUpRight size={40} />
                  </button>
                </div>
              </div>
              <div className="rounded-[40px] bg-black px-5 py-5">
                ...
                <div className="bg-white rounded-[40px] grid grid-cols-2 gap-2 mt-5 p-5">
                  <p className="text-xl font-medium rounded-full w-fit bg-black text-white px-5 pt-3">
                    Target
                  </p>{" "}
                  <p className="xl:text-6xl text-4xl font-bold">{goalData.goal.replace('lb', '')}lb</p>
                </div>
                ...
                <div className="grid grid-cols-2 pt-[60px] gap-2 items-center">
                  <GoalForm />
                  <button className="bg-indigo-400 text-white rounded-[30px] p-2">
                    Clear goal
                  </button>
                </div>
              </div>
